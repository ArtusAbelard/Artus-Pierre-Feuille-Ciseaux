       ...
       <div className="w-screen flex justify-center items-center flex-col gap-14 pt-14">
            ...
            <div className='h-1/2 w-full z-10 flex'>
                <div className='w-1/2 h-full  z-10 flex justify-center items-center ps-[15%]'>
                    <div onClick={props.btnacceuil} className='h-[250px] w-[250px] rounded-full bg-white border-[30px] border-blue-800 flex justify-center items-center'>
                        <img className='h-[100px]' src={paper} alt="" />
                    </div>
                </div>
                <div className='w-1/2 h-full z-10 flex justify-center items-center pe-[15%]'>
                    <div onClick={props.btnacceuilscissors} className='h-[250px] w-[250px] rounded-full bg-white border-[30px] border-yellow-800 flex justify-center items-center'>
                        <img className='h-[100px]' src={scissors} alt="" />
                    </div>
                </div>
            </div>
            <div className='h-1/2 w-full z-10 flex justify-center items-center pb-[3%]'>
                <div onClick={props.btnacceuilrock} className='h-[250px] w-[250px] rounded-full bg-white flex border-[30px] border-red-800 justify-center items-center'>
